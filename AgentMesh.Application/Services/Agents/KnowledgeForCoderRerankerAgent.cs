...
{
    public sealed class KnowledgeForCoderRerankerAgent(
        IOpenAIClientFactory openAIClientFactory,
        Resilience resilience,
        ILogger<KnowledgeForCoderRerankerAgent> logger,
        IAgentInputSerializer agentInputSerializer) : AbstractAgent<KnowledgeRerankerResult>(logger,
            "KnowledgeForCoderReranker",
            openAIClientFactory,
            resilience,
            agentInputSerializer)
    {
        private readonly ILogger<KnowledgeForCoderRerankerAgent> _logger = logger;
        ...
        protected override IEnumerable<AgentInputParameterConfiguration> GetAgentInputParameterConfiguration()
        {
            return [
                ...
                new() { ParameterType = typeof(KnowledgeQueryForCoderResultParameter), ParameterTags = [ParameterTags.AgentSystemParameterTag] }
                ];
        }
