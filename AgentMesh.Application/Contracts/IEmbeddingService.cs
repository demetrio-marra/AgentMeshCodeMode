namespace AgentMesh.Application.Contracts
{
    ...
    public interface IEmbeddingService
    {
        ...
        /// <returns>A task that represents the asynchronous operation. The task result contains the generated embedding as an array of floats.</returns>
        ...
        /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
        /// <returns>A task that represents the asynchronous operation. The task result contains a collection of generated embeddings, each represented as an array of floats.</returns>
